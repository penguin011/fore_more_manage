...
@section('content')
  ...
  <div class="block full">
      ...
      <div class="row">
        ...
        {!! Form::open(['url' => 'business_user_appointment','method' => 'get']) !!}
    ...
    {!! Form::select('status', [''=>'Select Status','Open' => 'Open',"Confirm" => 'Confirm',"Reschedule" => 'Reschedule',"Cancel" =>'Cancel'], $status, ['class' => 'form-control','id' => 'campaign_type']) !!}
        ...
        <div class="form-group col-md-2" style="margin-top: 2%;">
          ...
          <a href="{{ url('business_user_appointment') }}" class="btn btn-default">Clear</a>
        </div>
        <div class="form-group col-md-2" style="margin-top: 2%;">
         ...
         <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><center>&euro;<?php echo @$value['finalcash']; ?></center></td>
