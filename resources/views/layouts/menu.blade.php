...
<li class="{{ Request::is('tutorialMasters*') ? 'active' : '' }} 
           ...
           {{ Request::is('appScreenInformations*') ? 'active' : '' }}
           {{ Request::is('socialMediaMgts*') ? 'active' : '' }}">
    ...
    <ul>
        ...
        <li>
            ...
            <a class="{{ Request::is('socialMediaMgts*') ? 'active' : '' }}" href="{{ route('socialMediaMgts.index') }}"><span><i class="fa fa-circle-thin"></i> Social Media Mgts</span></a>
        </li>
        @endcan
        ...
        <li class="{{ Request::is('promotionalImageMasters*') ? 'active' : '' }}">
            <a href="{{ url('promotionalImageMasters') }}"><i class="fa fa-circle-thin"></i><span> Promotional Image</span></a>
        </li>
        @endcan
...
<li class="{{ Request::is('business_user_performance*') ? 'active' : '' }} 
           {{ Request::is('business_admin_use*') ? 'active' : '' }}
           {{ Request::is('business_user_order*') ? 'active' : '' }}
           {{ Request::is('business_user_appointment*') ? 'active' : '' }}">
    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-cup sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Reports</span></a>
    <ul>

    
     <li class="{{ Request::is('business_user_performance*') ? 'active' : '' }}">
        <a href="{{ url('business_user_performance') }}"><i class="fa fa-circle-thin"></i><span> Performance</span></a>
    </li>
    <!-- <li class="{{ Request::is('business_admin_use*') ? 'active' : '' }}">
        <a href="{{ url('business_admin_use') }}"><i class="fa fa-circle-thin"></i><span> User</span></a>
    </li> -->
    <li class="{{ Request::is('business_user_order*') ? 'active' : '' }}">
        <a href="{{ url('business_user_order') }}"><i class="fa fa-circle-thin"></i><span> Orders</span></a>
    </li>
    <li class="{{ Request::is('business_user_appointment*') ? 'active' : '' }}">
        <a href="{{ url('business_user_appointment') }}"><i class="fa fa-circle-thin"></i><span> Appointments</span></a>
    </li>
