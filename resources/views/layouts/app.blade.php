...
<head>
        ...
        <link rel="stylesheet" href="{{url('/new/css/validatior/developer.css')}}">
 ...
 <body>
                ...
                <div id="main-container">
                    ...
                    <header class="navbar navbar-default">
                        ...
                        <ul class="nav navbar-nav-custom pull-right">
                            ...
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="{{url('/backend/images/favicon.png') }}" alt="avatar"> <i class="fa fa-angle-down"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
     ...
     <!-- jQuery, Bootstrap.js, jQuery plugins and Custom JS code -->
        ...
        <script src="{{url('/new/js/validator/jquery.validate.min.js')}}"></script>
        <!-- <script src="{{url('/new/js/validator/additional-methods.js')}}"></script> -->
        <script src="{{url('/new/js/validator/validator.js')}}"></script>

        <!-- Google Maps API Key (you will have to obtain a Google Maps API key to use Google Maps) -->
        <!-- For more info please have a look at https://developers.google.com/maps/documentation/javascript/get-api-key#key -->
        <!-- <script src="https://maps.googleapis.com/maps/api/js?key="></script>
        <script src="{{url('/new/js/helpers/gmaps.min.js')}}"></script> -->

        <!-- Load and execute javascript code used only in this page -->
        <!-- <script src="{{url('/new/js/pages/index.js')}}"></script>
