...
<div id="excel" style="display: none;">
    ...
    <div class="form-group" id="free_voucher">
        ...
        <a download ="voucher.xlsx" href="<?php echo  url('//excel/sample_file/voucher.xlsx') ?>">Download</a>
    </div>

    <div class="form-group" id="free_supercode">
	    {!! Form::label('question_data', 'Download Super Code Sample Excel:') !!}
	    <a download ="supercode.xlsx" href="<?php echo  url('//excel/sample_file/supercode.xlsx') ?>">Download</a>
    </div>

    <div class="form-group" id="random_win">
	    {!! Form::label('question_data', 'Download Super Code Ramdom Winner Sample Excel:') !!}    
	    <a download ="supercode.xlsx" href="<?php echo  url('//excel/sample_file/randomWinExcel.xlsx') ?>">Download</a>
    </div>    
    <div class="form-group" id="point_excel">
	    {!! Form::label('question_data', 'Download Super Code Point Sample Excel:') !!}    
	    <a download ="pointCode.xlsx" href="<?php echo  url('//excel/sample_file/pointCode.xlsx') ?>">Download</a>
    </div>    
</div>
...
<div class="form-group">
    ...
    <div class="form-group" id="">
	    ...
	    <a download ="lotery_scenario_2.xlsx" href="<?php echo  url('//excel/sample_file/lotery_scenario_2.xlsx') ?>">Download</a>
    </div>
</div>
