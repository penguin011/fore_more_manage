  ...
  <style>
    * {
    ...
    body {
      ...
      background-image: url('../../new/img/resetbg.png');
...
<body>
  <div class="container">
    <div class="form">
      ...
      <!------ Login Form -------- -->
      <form class="login" action="{{ url('reset-password') }}" method="post">
        @csrf

        <img class="img-fluid" src="{{url('/new/img/forMoreWhite.png')}}" style="max-width: 100%;" alt="Logo Footer">
        <br />
        <br />
        <h1 style="text-align: center;color: white;">Rest Password</p>
          <br />
          ...
          <div class="formGroup">
            <input type="password" id="password" name="password" placeholder="Password" required autocomplete="off" maxlength="6">

          </div>
          <div class="formGroup">
            <input type="password" id="confirmpassword" name="password_confirmation" placeholder="Confirm Password" required autocomplete="off" maxlength="6">
