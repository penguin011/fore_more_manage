...
Route::post('/reset-password', 'PasswordResetController@submitResetPasswordForm');
/* End Don't Remove */
...
Route::group(['middleware' => ['auth', 'admin']], function () {
    ...
    Route::get('/business_user_performance_export/{start_date}/{end_date}', 'HomeController@business_user_performance_export');


    Route::get('/business_admin_use', 'HomeController@business_admin_user');
    Route::get('/business_user', 'HomeController@business_user');
    Route::get('/business_user_order', 'HomeController@business_user_order');
    Route::get('/business_user_appointment', 'HomeController@business_user_appointment');
    //Route::get('/business_admin_performance_export/{start_date}/{end_date}', 'HomeController@business_admin_performance_export');
    ...
    Route::get('/business_user_performance', 'HomeController@business_user_performance');
...
Route::get('get-media-list', 'HomeController@buss_mediaList');
