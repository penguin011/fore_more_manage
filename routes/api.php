...
Route::get('informative_page_guest', 'API\BrandAPIController@informative_page_guest');
...
Route::get('promotional_image_masters_by_country', 'API\Promotional_image_masterAPIController@get_promotional_image');
...
Route::get('social_media_link/{id}', 'API\Social_media_mgtAPIController@get_social_media_link');
Route::get('delete_user_account/{id}', 'API\AuthApiController@delete_user_account');