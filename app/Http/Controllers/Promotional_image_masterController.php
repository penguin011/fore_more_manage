...
class Promotional_image_masterController extends AppBaseController
{
    ...
    public function index(Promotional_image_masterDataTable $promotionalImageMasterDataTable)
    {
        ...
        $data = \App\Models\Promotional_image_master::orderBy('id', 'DESC')
            ->leftjoin('country', 'promotional_image_master.country_id', 'country.id')
            ->select('promotional_image_master.*', 'country.country_name')
            ->get();
        $data1 = [];

        return view('promotional_image_masters.index', compact('data'));
    }
    ...
    {
        $countryList = \App\Models\Country::pluck('country_name', 'id');
        return view('promotional_image_masters.create', compact('countryList'));
    }
    ...
    public function edit($id)
    {
        ...
        $countryList = \App\Models\Country::pluck('country_name', 'id');
        return view('promotional_image_masters.edit', compact('countryList'))->with('promotionalImageMaster', $promotionalImageMaster);
    }
