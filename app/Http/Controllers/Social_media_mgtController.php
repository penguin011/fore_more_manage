...
class Social_media_mgtController extends AppBaseController
{
    ...
    {   
        $data = \App\Models\Social_media_mgt::orderBy('id','DESC')->get();
                                    
                                    
      
        return view('social_media_mgts.index',compact('data'));
        ...
        if($request->hasfile('media_icon'))
            {
                ...
                $image = $request->file('media_icon');
                $extension = $image->getClientOriginalExtension(); // getting image extension
                $filename ='public/media/social_icon/media_icon/'.$image->getClientOriginalName();
                $path = public_path('/media/social_icon/media_icon/');
                $image->move($path, $filename);
                $input['media_icon'] = $filename;
            }else
            {
                $input['media_icon'] = '';
            }
