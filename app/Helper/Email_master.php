...

{
    ...
    public static function send_delete_acc_mail($user)
    { 
        Mail::send('emails.send_delete_email', $user, function($message) use ($user) {
        $message->to('delete@for-more.eu');
        $message->subject('Member Deleted');
        });
    }  
